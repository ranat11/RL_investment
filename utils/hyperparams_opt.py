...
def sample_ForexEnv0_params(trial: optuna.Trial) -> Dict[str, Any]:
    """
    ...
    :return:
    """
    window_size = trial.suggest_categorical("learning_starts", [5, 10, 25, 50, 100])
...
HYPERPARAMS_SAMPLER = {
    ...
    # env_id
    "ForexEnv-v0": sample_ForexEnv0_params,
}
